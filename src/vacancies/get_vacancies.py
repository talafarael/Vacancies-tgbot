import asyncio
from src.get_vacancies_collection.get_vacancies_collection_source import GetVacanciesCollectionSource
...
class GetVacancies(GetVacanciesSource):
    def __init__(
        self, cluster, getVacanciesDou: VacanciesDouSource, getVacanciesDjinni:VacanciesDjinniSource,getVacancieCollection:GetVacanciesCollectionSource,userManager:UserSource
    ):
    ...
    async def get_vacancy(self,vacancies):
        dou,djinni= await self.get_one_vacancies( vacancies["category"]["dou"], vacancies["experience"]["dou"], 
                                                vacancies["category"]["djinni"], vacancies["experience"]["djinni"]) 
        return dou,djinni
