    ...
    async def create_vacancies(self, value, name_value: str):
        ...
        for category in categories:
            for experience in experiencies:
                tasks.append(self.create_vacancies_relationship_collect(category["_id"], experience["_id"], category["name"]))
        
        await asyncio.gather(*tasks)
    async def create_vacancies_relationship_collect(self,id_category:str,id_experience:str,name:str):
        vacancies={
            "name":name,
