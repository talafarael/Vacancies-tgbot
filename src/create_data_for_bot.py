...
class CreateDataForBot:
    ...
    async def create_vacancies(self):
        ...
        for category in categories:
            for experience in experiencies:
                tasks.append(
                    self.create_vacancies_relationship_collect(
                        category["_id"],
                        experience["_id"],
                        category["name"],
                        category["name"],
    ...
    async def create_vacancies_relationship_collect(
        self, id_category: str, id_experience: str, name: str, experience: str
    ):
        vacancies = {
